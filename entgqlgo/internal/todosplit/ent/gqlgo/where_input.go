	...
	TodoWhereInputType = graphql.NewInputObject(graphql.InputObjectConfig{
		...
		Fields: graphql.InputObjectConfigFieldMapThunk(func() graphql.InputObjectConfigFieldMap {
			fields := graphql.InputObjectConfigFieldMap{
				...
				"priorityIsNil": &graphql.InputObjectFieldConfig{
					Type: graphql.Boolean,
				},
				"priorityNotNil": &graphql.InputObjectFieldConfig{
					Type: graphql.Boolean,
				},
...
func (i *TodoWhereInput) P() (predicate.Todo, error) {
	...
	if i.PriorityIsNil {
		predicates = append(predicates, todo.PriorityIsNil())
	}
	if i.PriorityNotNil {
		predicates = append(predicates, todo.PriorityNotNil())
	}
	if i.CreatedAt != nil {
...
func ParseTodoWhereInput(ctx context.Context, m map[string]interface{}) (*TodoWhereInput, error) {
	...
	// Parse priorityIsNil
	if v, ok := m["priorityIsNil"]; ok && v != nil {
		if b, ok := v.(bool); ok {
			input.PriorityIsNil = b
		}
	}
	// Parse priorityNotNil
	if v, ok := m["priorityNotNil"]; ok && v != nil {
		if b, ok := v.(bool); ok {
			input.PriorityNotNil = b
		}
	}
	// Parse createdAt
