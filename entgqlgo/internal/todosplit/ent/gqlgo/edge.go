...
func (r *FriendshipTodoResolver) Resolve(p graphql.ResolveParams) (interface{}, error) {
	...
	// Fall back to query
	edge, err := ent.QueryFriendshipTodo(r.client.Friendship, source).Only(p.Context)
	if err != nil {
		return nil, err
	}
	return edge, nil
...
func (r *FriendshipCategoryResolver) Resolve(p graphql.ResolveParams) (interface{}, error) {
	...
	// Fall back to query
	edge, err := ent.QueryFriendshipCategory(r.client.Friendship, source).Only(p.Context)
	if err != nil {
		return nil, err
	}
	return edge, nil
