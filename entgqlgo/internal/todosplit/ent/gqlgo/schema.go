		...
		Fields: graphql.Fields{
			"categories": &graphql.Field{
				...
				Resolve: func(p graphql.ResolveParams) (interface{}, error) {
					...
					query = CategoryQueryCollectFields(p.Context, p.Info, query)
			...
			"todos": &graphql.Field{
				...
				Resolve: func(p graphql.ResolveParams) (interface{}, error) {
					...
					if orderByArg, ok := p.Args["orderBy"].(map[string]interface{}); ok {
						order, err = ParseTodoOrder(orderByArg)
						if err != nil {
							return nil, fmt.Errorf("parsing orderBy: %w", err)
						}
					}
					return paginateTodoQuery(p.Context, query, args.After, args.Before, args.First, args.Last, order)
				},
			}, "node": &graphql.Field{
				Type: NodeInterface,
				Args: graphql.FieldConfigArgument{
