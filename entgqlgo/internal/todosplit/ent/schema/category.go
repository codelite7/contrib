...
// Category defines the category type schema. It owns the non-unique todos edge,
// exercising the AddEdgeIDs/RemoveEdgeIDs (entbuilder.ToAny) split-runtime path.
