...
// It is the split-runtime regression fixture for the "empty CreateFriendshipInput"
// bug: CreateFriendshipInput must carry the two edge ID fields (todoID/categoryID),
