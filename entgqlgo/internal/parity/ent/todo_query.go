...
var todoParentEdgeLoadDescriptor = entbuilder.EdgeLoadDescriptor[Todo, Todo, int, int]{
	...
	ExtractNodeFK: func(n *Todo) *int {
		return n.todo_children
	},
}
var todoChildrenEdgeLoadDescriptor = entbuilder.EdgeLoadDescriptor[Todo, Todo, int, int]{
	EdgeSpec: func() *sqlgraph.EdgeSpec {
		return entbuilder.NewEdgeSpec(entbuilder.EdgeSpecParams{
			Rel:          sqlgraph.O2M,
			Inverse:      false,
	...
	ExtractEdgeFK: func(e *Todo) *int {
		return e.todo_children
	},
}
var todoCategoryEdgeLoadDescriptor = entbuilder.EdgeLoadDescriptor[Todo, Category, int, int]{
	EdgeSpec: func() *sqlgraph.EdgeSpec {
		return entbuilder.NewEdgeSpec(entbuilder.EdgeSpecParams{
			Rel:          sqlgraph.M2O,
			Inverse:      true,
...
func (_q *TodoQuery) loadChildren(ctx context.Context, query *TodoQuery, nodes []*Todo, init func(*Todo), assign func(*Todo, *Todo)) error {
	query.withFKs = true
	return entbuilder.LoadEdgeO2M(ctx, &todoChildrenEdgeLoadDescriptor, nodes, init, assign,
		func(bool) {},
