...
const (
	// NullsFirst specifies nulls to be ordered first
	NullsFirst NullsDirection = "FIRST"
	// NullsLast specifies nulls to be ordered last
...
func (c Cursor[T]) String() string {
	...
	wc := base64.NewEncoder(base64.RawStdEncoding, &sb)
...
// MultiCursorsOptions are the options for building the cursor predicates.
